...
```
<img src="image/layout_sample.png">
...
```
<img src="image/layout_sample_row.png">
...
```
<img src="image/layout_sample_row_space.png">
...
```
<img src="image/layout_sample_column.png">
...
<img src="image/layout_sample_column_center.png">
...
以上で、Jetpack Composeで用いる主要なコンポーネントについての説明は終了です！  
それでは、Yatterの開発に入ってみましょう！
### [Yatterの解説資料へ](../../Yatter/0.環境構築/2_エミュレータ作成.md)