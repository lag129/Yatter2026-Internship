...
```
<img src="image/image_sample.png" width="250">


上記の例では、アプリ内にバンドルしている画像ファイルを画面一杯に表示しています(画像の追加方法についてはアイコン付きボタンで説明しています)
...
<img src="image/image_sample_size.png" width="250">
...
<img src="image/image_sample_fillmaxwidth.png" width="250">
...
<img src="image/image_sample_clip_circle.png" width="250">
...
<img src="image/image_sample_clip_corner.png" width="250">
